                  ...
                  <div class="row">
                      <div class="col l6 offset-l3 s12">
                        <p>
                          ...
                          <label for="sesi-1">Lanjut kaderisasi (termasuk ikut tugas besar)</label>
                        </p>
                        <p>
                          <input class="with-gap" name="sesi" type="radio" id="sesi-2" value="2" />
                          <label for="sesi-2">Hanya ikut tugas besar (fasilitas dari ARC berupa VM remote siap pakai. detail tugas besar menyusul)</label>
                        </p>
                      </div>
                  </div>
            </div>
                ...
                <div class="row">
                  ...
                  <div class="row">
                    <div class="input-field col l6 offset-l3 s12">
                      <textarea placeholder="Tolong diisi kenapa pilih lanjut / ikut tubes doang" id="alasan" class="materialize-textarea" name="alasan" pattern="[a-zA-Z]+\.[a-zA-Z]+\.+[a-zA-Z]" ></textarea>
                      <label for="alasan"></label>
                    </div>
                  </div>
                <div class="row">
                    <div class="col l6 offset-l3 s12">
                        <blockquote>Detail tugas besar menyusul.<br>Kalo submit lebih dari 1 kali, yang diambil yang terbaru.<br>Form ini ditutup hari kamis (09/3/17) jam 20:00
                        </blockquote>
                    </div>
                </div>
                  <center>
