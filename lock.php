...
-->
	    ...
	    <div class="light center"><h3 id="section-title">Form Sesi</h4></div>
            ...
            <form class="col s12" method="POST" action="">
              ...
              <div class="row">
                <div class="input-field col l6 offset-l3 s10 offset-s1">
                  <input placeholder="NIM" id="nim" type="text" class="validate" name="nim" pattern="[0-9]{8}" required="true">
                  <label for="nim"></label>
                </div>
              </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="row">
                    <div class="col l6 offset-l3 s12">
                        <blockquote><i>Kalo sodara(i) menemukan kecacatan atau kerentanan pada page ini harap kasih tau ke Line : nathanchrs atau fidrafid. Siapa tau dapet nilai++ .</i>
                        </blockquote>
                    </div>
                </div>
                  <center>
